...
//adapter for the friend request
public class FriendRequestAdapter extends RecyclerView.Adapter<FriendRequestAdapter.ReqViewHolder> {
    ...
    // View holder class for managing individual friend request views
    ...
    private List<Request> requests; // List of friend requests to display
    ...
    // Method to bind data to a friend request item
    @Override
    ...
    // Method to set the list of friend requests
    ...
    // Method to get the total number of friend requests
    @Override
